...
const LoginPage: React.FC<ILoginPageProps> = () => {
    ...
    return (
        <>
            <head>
                <title>Market Floor Admin</title>
                <link rel="icon" href="/favicon.ico"/>
            </head>
            <div className="flex h-screen items-center bg-gray-100 px-10 laptop:px-36">
                <div
                    className="flex h-[450px] w-screen flex-col items-center justify-center rounded-2xl border border-gray-100 bg-white px-2 shadow-2xl drop-shadow-sm phone:px-8 tablet:h-[500px] laptop:flex laptop:h-[600px] laptop:flex-row">
                                ...
                                return (
                                    <div className="space-y-7">
                                        <div className="space-x-1">
                                            <h1 className="text-center text-4xl font-bold text-gray-600">Market
                                                Floor</h1>
